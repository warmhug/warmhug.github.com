...
我做了一个产品经理应该做的工作，而且也拿到了 **文档易用性、oncall数量减少** 等不错的结果数据，并且对工作过程、也做了比较详细的文档记录，**从过程到结果**都证明了自己的付出和能力。但**这个事情的价值**、个人认为**没有被得到公正的对待**，在最终评价上、意思只是锦上添花。
...
除了兼职产品经理外，我作为业务和产品的owner、最终要承担**加倍的全面的责任和工作内容**，比如：

- 首先要对团队内一起协作的五个同学(全是96后)的工作、能深入理解并**有所帮助**，组织每周例会。
- 前期主要精力在产品文档oncall优化上、代码产出较少，主管提醒我**要体现代码产出**、于是我得花时间了解并修复些代码细节问题。
...
具体到前端和产品建设上，主管希望我做“Issue管理”功能、给产品带来新的亮点或破局，但我充分调研了app监控以及外部竞品、发现这个功能存在很强的“模糊地带”，而且实际效果都不够理想，大家也都 **没有很好的或一致的设计方案、没有能明确量化的目标**，想做的彻底或有明显效果、还要涉及到 **产品底层逻辑和产品设计上** 比较大的变化。另外整个过程中我需要全链路地、既做产品设计又做研发，个人又是第一次接触字节内部各类工具或平台，遇到很多比如 “工具平台繁多且上手复杂、产品相关功能有许多旧缺陷、英语沟通效率较低” 等等意想不到问题。最终做了两期功能、并和QA等协作同学制定了推广方案，但主管对这个结果不太满意并要求暂停推进。
> 后来了解到原因有几个方面 “一是在产品页面上没有非常明显的变化，二是主管和他的上级没完全对齐产品目标，三是开发时间节奏和其他后端高优需求插入” 等，总之当时客观条件非常不允许。

另外如前所述 个人精力比较分散、要兼顾投入到多个地方，也有一些 “文档/oncall优化/团队建设” 等亮点产出，但主管期望的是 **“业务破局”** 这个关键点上做到位。我至今 **反思了好多次** ，首先承认自己在监控领域的能力和经验需要更好外、其实有巨大的客观困难无法解决，一是这个功能本身的难度(跟主管和其他同学聊 都没有明确或更好的思路)、二是协作中各方(小组同学/产品经理/后端/后端主管)对这个功能看法和目标不一致难以调和的问题。

很多时候做成事、需要天时地利人和，对当时甚至是到现在的客观条件来说、这都是一个不可能做出亮眼成果的工作，反过来说、很可能就是当初立项时选错了大方向，但是需要我这个负责执行人来承担责任。我个人后来对业务理解越来越深后、并且基于客观条件可行性、思考规划一些可能**更有价值和ROI也较高**的事情：

- 产品信息结构的优化，能让用户有直接的收益、也可衡量出效果。
- 产品功能的原子化，做成一个个可装配的插件、方便集成或被集成，形成 workflow 的能力。
  - 比如关注 iPaas 平台，跟 AIOps SRE chatgpt 都有结合点。

但这些事情在好几个月里、只能处在脑暴和讨论阶段，也没有得到能落地的资源支持。不久后(去年八月末)我被调整工作内容、支持“后端监控-报警模块”的前端开发。我觉得这样刚好也能深入了解下后端监控是怎么玩的，当时就抱着简单浓厚的学习心态、投身其中。不太关注客观环境的变化，但发现自己太简单了，这块的前端支撑同学**近一年换了三个人、后端大主管也转岗走了**，原来有个实习生已经给了转正机会、也不来入职了。
